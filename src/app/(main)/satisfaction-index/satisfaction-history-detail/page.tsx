...
export default function SurveiDetailPage() {
  ...
  return (
    <div className="w-full h-full flex flex-col mx-6 px-5 py-6 bg-line-10 shadow-md rounded-lg mt-8 gap-y-8">
      <div className="grid grid-cols-2 md:grid-cols-none md:flex md:flex-row md:justify-between items-center md:w-full">
      ...
      <div className="flex flex-col border border-line-20 rounded-lg p-4 md:grid md:grid-cols-2 w-full mt-6 md:mt-0 gap-y-2 md:gap-y-4 px-8">
      ...
      <div className="flex flex-col w-full px-6 py-6 mt-2 md:mt-6 gap-y-4 md:gap-y-6">
        ...
        <div className="flex flex-col w-full gap-y-3">
          <h5 className="font-normal text-primary-40 text-sm">Pertanyaan 1</h5>

          <p className="text-black-80 text-sm">
            Apakah aplikasi BKD Lampung Timur yang digunakan mudah dipahami dan
