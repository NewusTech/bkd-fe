...
import ManagaApprovalsTablePages from "@/components/tables/admin_manage_approvals_table";
import FilterDataPages from "@/components/elements/data_filters";

export default function LeadManageApprovalsScreen() {
